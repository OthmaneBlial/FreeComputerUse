...
export function runtimeConfig(){
  ...
  if(!['openai-compatible','anthropic'].includes(providerKind))throw new Error('LLM_PROVIDER must be openai-compatible or anthropic');
