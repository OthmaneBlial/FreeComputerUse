...
- **Décision de faisabilité (24 septembre 2026) :** ne pas fabriquer de binaire autonome ni embarquer Chromium. Le runtime utilise `node:sqlite` et Playwright ; le navigateur Chromium associé à Playwright n’est pas installé. Seul macOS 26.6/Apple Silicon avec Node 25.9.0 et Chrome système 154.0.8037.57 est vérifié. La reconstruction npm de `1c31407` fait 1 135 828 octets et passe l’installation, `doctor` et les parcours sans modèle décrits en 6.1, sans téléchargement de navigateur ni Docker. La voie cohérente est une archive npm étiquetée avec ses prérequis Node/navigateur et checksum, une fois la version publiée. Aucun binaire ou asset public n’existe encore : tâche ouverte jusqu’à la release et au smoke de l’asset téléchargé.
