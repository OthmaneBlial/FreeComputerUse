...
- **Encore ouvert :** aucun test n’a été fait avec VoiceOver/NVDA; l’arbre AX de Chrome ne prouve pas le résultat vocal ni l’ordre de lecture. Le rendu du README dans GitHub reste à contrôler. Le GIF montre un workflow synthétique et ne remplace pas la vidéo finale réelle de phase 8. Ne pas cocher la phase tant que ces contrôles restent ouverts.
