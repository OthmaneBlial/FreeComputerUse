...
- DeepSeek live smoke: one completion passed on 23 September 2026 using the
  ...
  vendors.
- Full serial `FCU_BROWSER_CHANNEL=chrome npm test`: passed 99/99 on 24 September
  2026 in 148.7 seconds, with system Chrome `154.0.8037.57`, macOS `26.6`, and
