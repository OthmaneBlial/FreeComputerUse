...
| 64–65: naming and developer experience | Existing workspace name retained; GitHub repo created; local and global npm install/config/dev, source and built CLI, browser install documented; published npm `0.2.1` install, doctor, synthetic CLI tasks and dashboard verified; published `0.2.0` MCP tool discovery verified |
